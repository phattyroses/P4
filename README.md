...
Changed the number of moveable pizzas drawn from 200 down to 20.
Moved the moving pizzas (.mover) to their own layer via transform: translateZ(0)
Optimized the size and compression of photos.
# P4
# P4
# P4
# P4
